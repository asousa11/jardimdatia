            ...
            <div class="col-md-12">
                <div class="card mt-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                @if($venda->aberta)
                                    ...
                                    {{--                                    <label style="margin-left: 2%;">Aberta</label>--}}
                                @else
                                    <h1 style="font-weight: 700">Fechada</h1>
                                    {{--                                    <label style="margin-left: 2%;">Fechada</label>--}}
                                @endif
                    ...
                    <div class="card-body p-5">
                        ...
                        <div class="form-group row">
                            <label for="nome">Saldo em Cartão:</label>
                            <label style="margin-left: 2%;">{{ number_format($venda->cliente->cartao->saldoAcumulado,2)}} &euro;</label>
                        </div>
                    </div>
                        ...
                        <table class="table">
                            ...
                            @foreach($venda->vendaProduto as $vp)
                                <tr>
                                    ...
                                    @else
                                        <td>0,00 &euro;</td>
                                        <td style="background: #00AAAA; color: white">{{number_format($vp->preco * $vp->quantidade,2)}} &euro;</td>
                                    @endif
                                </tr>
                            @endforeach
                        ...
                        <div class="card-body p-5">
                            <div class="form-group row">
                                ...
                                <a href="/vendas/{{$venda->id}}/finalizarcomcartao" style="padding: 5px">
